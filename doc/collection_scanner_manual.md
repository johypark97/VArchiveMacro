...
6. 스캔이 완료되면 처리기의 검토 단계에서 정확히 스캔되었는지 확인합니다.
   ...
   - **정확**
     ...
     100% 정확히 인식한 곡들은 정확 (초록색) 으로 표시되고 자동으로 선택되므로 별다른 조취가 필요하지 않습니다. (정확은 기본 숨김 필터이므로 표시되지 않습니다. 상단 필터를 변경하면 표시됩니다.)
...
1. 캡처 설정
   ...
   - **Windows Graphics Capture 사용 (실험적)**: 화면 캡처에 WGC를 사용합니다. 실험적 기능으로 버그가 있을 수 있습니다.
   - **HDR/SDR 톤 매핑 (실험적)**: HDR/SDR 캡처 지원을 활성화합니다. WGC 사용이 설정되어 있어야 사용할 수 있으며, 실험적 기능으로 버그가 있을 수 있습니다.
