...
- v2.8.0 (2026-03-09)
  ...
  - V-Archive OPEN API 버전 업데이트
    - 유저 기록 조회에 v2 API를 사용하도록 수정
  - 업데이트 확인 기능 버그 수정
    - 선공개(pre-release) 버전의 업데이트 알림이 뜨지 않는 문제 수정

## 2025

- v2.7.3-alpha.1 (2025-12-27)

  - 업데이트 확인 기능 버그 수정
    - 특정 네트워크 환경에서 발생하는 보안 인증서 문제를 해결하기 위해 시스템 프록시 설정과 루트 CA 인증서 설정을 추가
